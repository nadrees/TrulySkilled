    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(RegisterExternalLoginModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    UserProfile user = await db.UserProfiles.FirstOrDefaultAsync(u => u.UserName.ToLower() == model.UserName.ToLower());
        ...
        [AllowAnonymous]
        [ChildActionOnly]
        public ActionResult ExternalLoginsList(string returnUrl, bool isManage = false)
        {
            ViewBag.ReturnUrl = returnUrl;
            ViewBag.IsManage = isManage;
            if (isManage)
                ViewBag.ExternalLogins = GetExternalLogins();
        ...
        {
            var externalLogins = GetExternalLogins();
